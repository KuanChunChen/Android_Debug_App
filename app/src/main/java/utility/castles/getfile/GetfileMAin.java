...
public class GetfileMAin {
    ...
    public String readFile(String strFileName, String strFileType,String strFilePath) {
    ...
    public boolean delFile(String strFileName, String strFileType,String strFilePath) {
